...
class Director:
    ...
    def _plan_scenes(
        ...
        user_msg = (
            ...
            f"  style_seed: {brief.style_seed or 'unspecified'}\n\n"
            "The style_seed is a creative directive — bend your block choices, "
            "durations, and copy towards that style when it's set.\n\n"
